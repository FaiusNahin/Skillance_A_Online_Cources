...
const Footer = () => {
    return (
        <div className="flex justify-center bg-indigo-900 py-24 px-72">
            <div className=" grid grid-cols-5 justify-items-center">
                ...
                <div className="col-span-2">
                    ...
                    <form>
                        <input className="w-60 py-3.5 pl-3 rounded-l-md text-lg" type="text" placeholder="Email Address" />
                        <button className="text-lg text-white bg-heading py-3.5 px-3.5 rounded-r-md">Subscribe</button>
                    </form>
                </div>
