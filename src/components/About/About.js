        ...
        <div className="flex items-center justify-center px-72 py-28">
            <div className="w-2/4 pl-28">
                ...
                <div className="text-gray-700 font-bold text-lg mb-8 pt-3">
                    ...
                    <p className="my-4"><span><i className="fas fa-check text-passion bg-red-50 p-2.5 rounded-full mr-2.5"></i></span> 20+ Downloadable Resources</p>
                    ...
                    <p className="my-4"><span><i className="fas fa-check text-passion bg-red-50 p-2.5 rounded-full mr-2.5"></i></span> Free Trial 7 Days</p>
                </div>
