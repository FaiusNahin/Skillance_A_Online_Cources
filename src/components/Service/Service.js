        ...
        <div className="shadow-all p-3 rounded-lg">
            <div>
                ...
                <div className="pt-3 px-1">
                    ...
                    <h2 className="font-semibold text-lg sm:text-xl py-3.5">{title}</h2>

                    <div className="flex flex-wrap items-center  text-lg text-gray-600 pb-4 gap-y-2 sm:gap-y-0 md:flex-row">

                        <p className="mr-4 sm:mr-6 xl:mr-8"><span className="text-pink-600 text-base"><i className="fas fa-clock"></i></span> {hour} hr {minutes} min</p>

                        <p className="ml-3 sm:ml-0 sm:mr-6 xl:mr-8"><span className="text-passion text-base"><i className="fas fa-video"></i></span> {lecture} Lectures</p>

                        <p className=""><span className="text-indigo-900 text-base"><i className="fas fa-signal"></i></span> {level}</p>
                    </div>
